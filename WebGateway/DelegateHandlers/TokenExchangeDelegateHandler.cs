...
namespace WebGateway.DelegateHandlers
{
    public class TokenExchangeDelegateHandler : DelegatingHandler
    {
        ...
        public async Task<string> GetToken(string requestToken)
        {
            ...
            {
                Address = _configuration["IdendityServerUrl"],
            ...
            TokenExchangeTokenRequest req = new TokenExchangeTokenRequest()
            {
            ...
            var tokenResponse = await _httpClient.RequestTokenExchangeTokenAsync(req);
